...
var Drawer = styled.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: absolute;\n  box-sizing: border-box;\n  height: 100%;\n  width: ", "px;\n  top: 0;\n  right: 0;\n  padding: 0 15px;\n  background-color: rgba(0,0,0,0.6);\n  z-index: 500;\n  color: #999;\n  cursor: default;\n\n  & h3 {\n    color: white;\n    font-size: 18px;\n    & svg {\n      vertical-align: text-top;\n      cursor: help;\n    }\n  }\n  transition: transform 0.25s ease;\n  transform: translate3d(0,0,0);\n\n  @media (max-width: 500px) {\n    width: 100%;\n    padding: 0 65px;\n    ", "\n  }\n"])), DRAWER_WIDTH, function (props) {
  return !props.open ? "\n      transform: translate3d(0,0,0);\n    " : "\n      transform: translate3d(0,calc(100% - 32px),0);\n    ";
});
var Bar = styled.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  width: 150px;\n  height: 2px;\n  background-color: white;\n  margin: 0 auto;\n"])));
...
var ListItem = styled.li(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  list-style-type: none;\n  display: flex;\n  align-items: center;\n  margin: 12px 0;\n  font-size: 18px;\n\n  ", "\n\n  ", "\n"])), function (props) {
